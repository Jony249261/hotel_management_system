...
<div class="card shadow mb-4">
                        <div class="card-header py-3 bg-primary" >
                            <h6 class="m-0 font-weight-bold text-light">Edit Customer
                            ...
                            <div class="table-responsive">
                                <form action="{{url('admin/customer/'.$data->id)}}" method="post" enctype="multipart/form-data">
                                    ...
                                    <table class="table table-bordered" >
                                        ...
                                        <tr>
                                            <th>Full Name</th>
                                            <td><input name="full_name" type="text" class="form-control" value="{{$data->full_name}}">
                                                @error('full_name')
                                        ...
                                        <tr>
                                            <th>Address</th>
                                            <td><input name="address" type="text" class="form-control" value="{{$data->address}}">
                                                @error('address')
                                                <span class="text-danger">{{$message}}</span>
                                                @enderror
                                            </td>
