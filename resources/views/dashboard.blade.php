            ...
            <div class="card-body">
                ...
                <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                <a href="{{url('admin/booking')}}" style="list-style:none !important; text-decoration:none !important" class="list_style">Bookings</a></div>
            ...
            <div class="card-body">
                ...
                <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                 <a href="{{url('admin/customer')}}" style="list-style:none !important; text-decoration:none !important" class="list_style">Customers</a>
                                            </div>
    ...
    <div class="col-xl-3 col-md-6 mb-4">
        <div class="card border-left-info shadow h-100 py-2">
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1"><a href="{{url('admin/rooms')}}" style="list-style:none !important; text-decoration:none !important" class="list_style">Rooms</a>
                                            </div>
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <a href="{{url('admin/staff')}}" style="list-style:none !important; text-decoration:none !important" class="list_style">Staff</a>
                                        </div>
